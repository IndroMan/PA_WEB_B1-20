		...
		<table style="width: 32%;">
			...
			<tr>
				<td>
					...
					<a href="pelanggan.php?search=<?= $mter ?>" class="button">Kembali</a>
					<?php else: ?>
					<a href="penggunaan.php?serch=<?= $mter ?>" class="button">Kembali</a>
					<?php endif ?>
				</td>
				<td><input type="submit" name="baru" value="Tambah" class="inp button"></td>
			</tr>
			...
			<tr>
				<td><a href="penggunaan.php?serch=<?= $_GET['ubh'] ?>" class="button">Kembali</a></td>
				<td><input type="submit" name="edit" value=" Edit " class="inp button"></td>
			</tr>
			<?php else:
