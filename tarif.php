...
<div id="atas">
	<div class="right"><br>
		<a href="form-tarif.php" class="button">+Tarif baru</a></div>
	<div class="clear"></div>
</div>
<div id="badan">
	<table id="data">
		...
		while ($tarif = mysqli_fetch_assoc($mt)) {
			...
			<tr>
				...
				<td>
					<a href="form-tarif.php?trf=<?= $tarif['id_tarif'] ?>" class="button">ubah harga</a>
					<a onclick="hpstar('<?= $tarif['id_tarif'] ?>')" class="button">Delete</a>
				</td>
			</tr>
		<?php } ?>
	</table>
