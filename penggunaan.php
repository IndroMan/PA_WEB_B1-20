...
<div id="atas">
	...
	<div class="right"><br>
		...
		<a href="pelanggan.php?search=<?= $_GET['serch'] ?>" class="button">Kembali</a>
		<?php elseif(isset($_GET['bln'])): ?>
		<a href="penggunaan.php?serch=<?= $_GET['serch'] ?>" class="button">Kembali</a>
		<?php else: ?>
...
<div id="badan">
	<table id="data">
		...
		while ($pggn = mysqli_fetch_assoc($pgn)) {
			...
			<tr>
				...
				<td>
					...
					<a href="form-penggunaan.php?ubh=<?= $pggn['no_meter'] ?>" class="button">Ubah MA</a>
					<?php else: ?>
					Nunggak!!
					<?php endif ?>
				</td>
		...
		<tr>
			...
			<td> -- </td>
			<td>
				<a href="form-penggunaan.php?pgn=<?= $tes['no_meter'] ?>" class="button">+ MA</a>
			</td>
		</tr>
		<?php //endif ?>
		<?php endif ?>
