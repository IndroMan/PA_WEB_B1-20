...
<body>
	...
	<div id="saran" align="center">
		...
		<form action="#" method="post">
			<table width="800">
				...
				<tr>
					<td></td>
					<td><br><input type="submit" name="kirim" value="Kirim" class="input btn"></td>
				</tr>
			</table>
		</form>
	</div>
	<div id="footer" align="center">
		<br>
		<p>Indro Dwi Saputro
		<p>Gmail : indrodwi2@gmail.com<br>No telp : 085156601376 <br>Alamat : Jln.Subulussalam
		<br><br> Universitas Mulawarman <br> Fakultas Teknik
		<br>Informatika B 2020</p>
		</p>
		<br>
		<p>&copy;IndroMamen</p>
	</div>
