...
<div id="atas">
	<div class="left">
		<br>Pilih Tugas :
		<a href="petugas.php?lvl=0" class="button">catat meter</a>
		<a href="petugas.php?lvl=1" class="button">Kasir pembayaran</a>
		<a href="petugas.php?lvl=2" class="button">operator meter</a>
		<a href="petugas.php?lvl=3" class="button">admin</a>
		<a href="petugas.php" class="button">refresh</a>
	</div>
	<div class="right"><br><a href="form-petugas.php" class="button">+Petugas</a></div>
	<div class="clear"></div>
</div>
<div id="badan">
	<table id="data">
		...
		while ($ptgs = mysqli_fetch_assoc($mt)) {
			...
			<tr>
				...
				<td>
					<a href="form-petugas.php?ptgs=<?= $ptgs['id_login'] ?>" class="button">Ubah data</a>
					<?php if ($ptgs['aktif'] == 1): ?>
						<a onclick="nonaktif('<?= $ptgs['id_login'] ?>')" class="button">Nonaktifkan</a>
						<?php else: ?>
							<a onclick="aktif('<?= $ptgs['id_login'] ?>')" class="button">Aktifkan</a>
						<?php endif ?>
					</td>
				</tr>
			<?php } ?>
